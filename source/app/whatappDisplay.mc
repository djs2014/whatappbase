...
module WhatAppBase {
  class WhatDisplay {
    ...
    hidden var mFontsTopAndBottomValue as Array = [
      Graphics.FONT_TINY,
    ...
    hidden var COLOR_MAX_PERCENTAGE as ColorType =
      Colors.COLOR_WHITE_DK_PURPLE_4;
    ...
    function isHiddenField() as Boolean {
      return fieldType == Types.HiddenField;
    }
    function isSmallField() as Boolean {
      return fieldType == Types.SmallField;
    }
    function isWideField() as Boolean {
      return fieldType == Types.WideField;
    }
    function isLargeField() as Boolean {
      return fieldType == Types.LargeField;
    }
    function isOneField() as Boolean {
      return fieldType == Types.OneField;
    }
    function isNightMode() as Boolean {
      return nightMode;
    }
    function setNightMode(nightMode as Boolean) as Void {
      self.nightMode = nightMode;
    }
    function setMiddleLayout(middleLayout as LayoutMiddle) as Void {
      self.middleLayout = middleLayout;
    }
    function setShowTopInfo(showTopInfo as Boolean) as Void {
      self.showTopInfo = showTopInfo;
    }
    function setShowLeftInfo(showLeftInfo as Boolean) as Void {
      self.showLeftInfo = showLeftInfo;
    }
    function setShowRightInfo(showRightInfo as Boolean) as Void {
      self.showRightInfo = showRightInfo;
    }
    function setShowBottomInfo(showBottomInfo as Boolean) as Void {
    ...
    function onLayout(dc as Dc) as Void {
      ...
      //System.println("field height " + fieldHeight);

      // @@ function to set fonts + some dimensions
      mRadiusInfoField = Utils.min(
        fieldWidth / 4,
        fieldCenterY + 10
      ).toNumber();
      ...
      if (fieldHeight < 155) {
        mFontBottomValueStartIndex = 2;
      }
      if (isSmallField()) {
        mRadiusInfoField = 29;
        mFontValueStartIndex = 2;
    ...
    function leftAndRightCircleFillWholeScreen() as Boolean {
      return (
        fieldWidth - 40 < 4 * mRadiusInfoField + (marginLeft + marginRight)
      );
    }
    ...
    function drawTopInfo(
      ...
      var fontValue = Utils.getMatchingFont(
        dc,
        mFontsTopAndBottomValue,
        mRadiusInfoField * 3,
        value,
        mFontBottomValueStartIndex
      );
      ...
      if (!isSmallField() && leftAndRightCircleFillWholeScreen()) {
        ...
        // var fontValue = Utils.getMatchingFont(dc, mFontsTopAndBottomValue, mRadiusInfoField * 3, value, mFontBottomValueStartIndex);
        drawAdditonalInfoFG(
          barX,
          color,
          value,
    ...
    function drawTopInfoTriangle(
      color as ColorType,
      value as String,
      backColor as ColorType,
      units as String,
      outlineColor as ColorType,
      percentage as Numeric,
      color100perc as ColorType?,
      label as String
    ) as Void {
      var dc = mDc as Dc;
      ...
      var left = new Utils.Point(
        fieldCenterX - wBottomBar / 2,
        fieldHeight - margin - heightBottomBar
      );
      var right = new Utils.Point(
        fieldCenterX + wBottomBar / 2,
        fieldHeight - margin - heightBottomBar
      );
      ...
      if (!isSmallField()) {
        ...
        // white/background
        pts = Utils.getPercentageTrianglePts(
          topInner,
          leftInner,
          rightInner,
          100
    ...
    function drawBottomInfoFG(
      ...
      if (leftAndRightCircleFillWholeScreen()) {
        ...
        var fontBottomValue = Utils.getMatchingFont(
          dc,
          mFontsTopAndBottomValue,
          mRadiusInfoField,
          value,
        ...
        dc.drawText(
          fieldCenterX + widthValue / 2 + marginleft2,
          y,
          mFontUnits,
          units,
      ...
      dc.drawText(
        xv + widthLabel + marginleft1 + widthValue + marginleft2,
        y,
        mFontUnits,
        units,
        Graphics.TEXT_JUSTIFY_LEFT | Graphics.TEXT_JUSTIFY_VCENTER
    ...
    hidden function _drawBackgroundPercRectangle(
      x as Number,
      y as Number,
      width as Number,
      height as Number,
      colorPercentageLine as ColorType,
      color100perc as ColorType?,
      percentage as Numeric,
      lineWidth as Number
    ) as Void {
    ...
    function drawLeftInfo(
      ...
      if (
        !drawAdditonalInfoFG_Info(barX, fontValue, info, mFontLabelAdditional)
      ) {
        drawAdditonalInfoFG_Info(barX, fontValue, units, mFontLabelAdditional);
      }
    ...
    hidden function drawAdditonalInfoBG(
      x as Number,
      width as Number,
      color as ColorType,
      percentage as Numeric,
      color100perc as ColorType?,
      outlinePerc as Numeric,
      outlineColor as ColorType,
      outlineColor100perc as ColorType?
    ) as Void {
      var dc = mDc as Dc;
    ...
    function drawMaxInfo(
      barX as Number,
      width as Number,
      maxPercentage as Numeric?,
      loopIndicator as Number
    ) as Void {
      ...
      Utils.drawPercentagePointerOnCircle(
        dc,
        barX,
        y,
        w,
    ...
    hidden function drawAdditonalInfoFG(
      x as Number,
      color as ColorType,
      value as String,
      fontValue as FontType,
      units as String,
      fontUnits as FontType,
      label as String,
      fontLabel as FontType,
      percentage as Numeric
    ) as Void {
      ...
      if (!isSmallField() && label != null && label.length() > 0) {
        ...
        var yLabel =
          fieldCenterY -
          dc.getFontHeight(fontValue) / 2 -
          dc.getFontHeight(fontLabel) / 2 +
          marginTop;
        dc.drawText(
          x,
          yLabel,
    ...
    hidden function drawAdditonalInfoFG_Info(
      x as Number,
      fontValue as FontType,
      units as String,
      fontUnits as FontType
    ...
    hidden function drawAdditonalInfoOutline(
      x as Number,
      width as Number,
      color as ColorType
    ) as Void {
